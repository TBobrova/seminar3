...
Для того чтобы разрешить конфликт после слияния веток необходимо:

*вручную выьрать необходимый для сохранения результат;
*сохранить cntrl+s
*создать commit с комментарием о решении конфликта
